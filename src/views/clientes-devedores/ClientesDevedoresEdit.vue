    ...
    <div>
        ...
        <div class="container">
            ...
            <form class="row">
                ...
                <div class="col-md-12">
                    <button type="button" class="btn btn-primary" @click="updateClienteDevedor">
    ...
    methods: {
        ...
        getDebito() {
            ...
            .then(response => {
                ...
                this.motivo_debito = response.data.motivo_debito;
                this.montante_original = response.data.montante_original;
                this.valor_atualizado = response.data.valor_atualizado;
                this.cliente = response.data.cliente.id;
                this.devedor = response.data.devedor.id;
            })
            .catch(error => {
                console.log(error);
            });
        ...
        updateClienteDevedor() {
            ...
            axios.put(url('/clientes-devedores/' + this.$route.params.id), JSON.stringify(data), headers)
            .then(response => {
